...
#define COMMAND_ARDUINO_BUZ 0xAD     // Actuate Buzzer
#define COMMAND_ARDUINO_CMP 0xAC     // Read Compass
#define COMMAND_ARDUINO_SNR 0xAB     // Read Sonar
#define COMMAND_ARDUINO_SERVO1 0xAA  // Actuate gripper1
#define COMMAND_ARDUINO_SERVO2 0x9F  // Actuate gripper2
=======
#define COMMAND_ARDUINO_DIG3	0xB8 //Read digital3 value
#define COMMAND_ARDUINO_DIG4	0xB7 //Read digital4 value
#define COMMAND_ARDUINO_DIG5	0xB6 //Read digital5 value
...
>>>>>>> 6050bac (Finish AppUSBControl and Fix BnrCompass so that it doesn't get stuck when not connected)
