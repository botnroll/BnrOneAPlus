...
#define COMMAND_MOVE_PID 0xF3     // Move motors PID
// Set motors calibration parameters (SPow, ctrl_pulses)
#define COMMAND_MOVE_RAW 0xF2    // Move motors without PID control
...
#define COMMAND_SET_PID 0xEC      // Set kp, ki, kd values for PID control
...
#define COMMAND_OBSTACLES \
  0xD5  // Read IR obstacle sensors (1, 2 or 3) -> RobertaLab compatibility
