 ...
 * control the robot with IR. This function is used in the race challenge to
 * detect the start of the race!
 *
 */
...
void loop() {
  ...
  ir_sensors = one.readObstacleSensors();  // read actual IR sensors state
